...
// we use <TouchableHighlight> so we could register touch events!
// note the View's style, which allows to override the background color by clients.
// note also the Text's passed-in properties, so we can include them in our button.
